...
#slide[
  ...
  #text(size: 38pt)[*Refinement Types for Verified Systems*]
...
#slide[
  ...
  #text(size: 38pt)[*Program Verification for the 21st Century*]
...
#slide[
  ...
  #one-by-one[][Iterations, ][Collections, ][$lambda$-Abstractions, ...]
]
